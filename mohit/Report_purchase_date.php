...
$result17 = mysql_query("SELECT `purchaseid`, DATE_FORMAT(p_date,'%d/%m/%Y')   as  sdate, `vendor_id`, `p_receipt`, `total`, `p_notes`, `user_ent`, `vend_name` FROM `purchase_invoice` WHERE 
p_date between STR_TO_DATE('$st_1','%d/%m/%Y')  and STR_TO_DATE('$end_1','%d/%m/%Y') order by 1 desc");
...
<tr> <th style="text-align:center" colspan="6"  > <font color="blue"> <h4>OPEN STOCK PURCHASE REPORT BETWEEN <?php echo  $st_1 ?>  AND <?php echo  $end_1 ?>   </h4> </font> </th>  </tr>
...
<tr> <th style="text-align:center" colspan="6"  > <font color="blue"> <h4>MRP PURCHASE REPORT BETWEEN <?php echo  $st_1 ?>  AND <?php echo  $end_1 ?>   </h4> </font> </th>  </tr>
<tr bgcolor="orange"  > <th> SNO </th>  <th> RECEIPT NO </th>  <th> DATE </th>  <th> VENDOR  </th> <th> NET PURCHASE  </th>  </tr> 
...
while($row13 = mysql_fetch_array($result17))
 ...
 <tr>
   ...
   <td>  <?php  echo $i;  ?>  </td>
   <td><font color="#663300"><a href="show_mrp_purchase.php?id= <?php echo $row13['purchaseid']?> "> <?php echo  $row13['p_receipt']?>  </a></font></td>
   <td>  <?php echo  $row13['sdate'] ?> </td>
   <td> <?php echo  $row13['vend_name'] ?>  </td>
   <td align = "right"> <?php echo  $row13['total'] ?>  </td>
