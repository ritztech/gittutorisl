...
<tr>
   ...
   <td>SELECT MEDICINE </td> <td> <select name = "item_id">
...
$result22 = mysql_query("SELECT `desc` FROM `m_master_store` WHERE `id` = $item_id ");
$row22 = mysql_fetch_array($result22);



$result13 = mysql_query("select sin.billno,sin.sell_date,mms.desc,sum(sit.qty)
from sell_invoice sin,
sell_items sit,
m_master_store mms
where mms.id = sit.itemid
...
$result18 = mysql_query("select pin.purchaseid,pin.p_date,mms.desc,sum(pit.quantity)
from purchase_item pit,
purchase_invoice pin,
m_master_store mms
where mms.id = pit.ited_id
...
<tr> <th style="text-align:center" colspan="4"  > <font color="blue"> <h4>SALE REPORT BETWEEN <?php echo  $st_1 ?>  AND <?php echo  $end_1 ?>  for <?php echo  strtoupper($row22['0']) ?>  </h4> </font> </th>  </tr>
...
<tr> <th style="text-align:center" colspan="6"  > <font color="blue"> <h4>PURCHASE REPORT BETWEEN <?php echo  $st_1 ?>  AND <?php echo  $end_1 ?>  for <?php echo  strtoupper($row22['0']) ?>  </h4> </font> </th>  </tr>
<tr bgcolor="yellow"  > <th> BILL NO</th> <th> DATE </th>  <th> ITEM NAME  </th> <th> QUANTITY </th>   </tr> 
