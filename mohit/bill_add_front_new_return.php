...
//alert(valuecnt);
   ...
   // code to add duplicate in one row 
	...
	if(duplicate == 0)
	{addRow('dataTable',arfruits[0],arfruits[1],arfruits[2],arfruits[3],arfruits[5],arfruits[6],arfruits[7]);
	}
...
if(p_bal_z > "0")
{
	...
	if( document.form2.retcomm.value == "" )
   {
     alert( "Please fill  return comments  .. !" );
     document.form2.retcomm.focus() ;
     return false;
   }
...
<form  id="form2" name = "form2" method="post"    action="bill_add_back_return.php">

<br>

<div  align = "center">  <b>  RETURN SALES   </b>  </div>
<table   width="100%"  border="1" style="border-collapse:collapse;"    bgcolor="white" align="center"  >
...
<table width="100%" cellspacing="0" cellpadding="0" border="1"  bgcolor="white" align="center" >
...
<tr style="background-color:#000000;  color:#FFF;">  <td colspan = 2 align = "center">
 ...
 PAID<input type = "text" onKeyUp="balancecalc()"   name = "paid" size="4"   id = "paid"/>
 BALANCE <input type = "text" readonly name = "balance" size="3" value = "0" id = "balance"/>
...
<td colspan = 2 align = "center"> 
 ...
 <input   name="custid"   id="custid"  value = "1"  type="hidden"   size = "5">	  
	...
	while($query1_data = mysql_fetch_array($result_sales)){
	 ...
	 <tr style="background-color:#000000;  color:#FFF;">  <td align = "center"> RETURN  COMMNETS :  <input type = "text"  id = "retcomm"  size = "50" value = "" name = "retcomm" />  </td> </tr>
...
<table width="100%"  id="dataTable" border='1' style="border-collapse:collapse;" cellpadding='1'   >
  ...
  <tr>
    <th>  </th>  <th>Check</th>    <th>SNO</th>   <th>ITEM NAME</th>  <th>WEIGHT</th>  <th>MRP</th>  <th>PRICE</th>  <th><font color="red"> QTY </font> </th>  <th>SAVINGS</th> <th>TOTAL</th>  
  </tr>
