...
<form  name = "form1" action = "add_salesman_bck.php"  method = "post" >

 <h3 align="center"> ADD NEW SALESMAN  </h3>  
</br>
...
<table width="200" border="1" align="center">
  <tbody>
    ...
    <tr>
      <td>Contact:</td>
      <td><input type = "text" size = "50" name = "cnt" id = "cnt"/></td>
    </tr>
    <tr>
      <td>Address:</td>
...
<br>
 <h3 align="center"> EXISTING SALESMAN </h3> 
<table border='1' cellpadding='3' align="center" >
<tr>
<tr> <th> NAME </th> <th> CONTACT </th> <th> ADDRESS </th> <th> EDIT </th>  </tr>

<?php
$result13 = mysql_query("SELECT `id`, `name`, `contact`, `address` FROM `m_salesman`");
...
<td><b><font color="#663300"><a href="edit_salesman_rec.php?id=<?php echo  $row13['0']?>">EDIT</a></font></b></td>
</tr>
