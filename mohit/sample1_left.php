...
<b><INPUT class = "submenu"    Type="BUTTON" VALUE="ADD BILL" ONCLICK="window.location.href='bill_add_front_new.php'"> </b></br></br>
...
<b><INPUT class = "submenu"    Type="BUTTON" VALUE="ADD NEW ITEM" ONCLICK="window.location.href='master_add_front.php'"> </b></br></br>
<b><INPUT class = "submenu"   Type="BUTTON" VALUE="EDIT ITEM" ONCLICK="window.location.href='ed_master_add_front.php'"> </b></br>
</br>

<b><INPUT class = "submenu"    Type="BUTTON" VALUE="ADD USER" ONCLICK="window.location.href='add_user_front.php'"> </b></br></br>

<b><INPUT class = "submenu"   Type="BUTTON" VALUE="ADD PURCHASE" ONCLICK="window.location.href='purchase_add_front.php'"> </b></br></br>
<b><INPUT class = "submenu"   Type="BUTTON" VALUE="MASTERS" ONCLICK="window.location.href='main_masters.php'"> </b></br></br>
<b><INPUT class = "submenu"   Type="BUTTON" VALUE="SHORT-STOCK" ONCLICK="window.location.href='out_of_stock.php'"> </b></br></br>
...
<b><INPUT class = "submenu"   Type="BUTTON" VALUE="DUPLICATE BILL" ONCLICK="window.location.href='Return_bill_front_1.php'"> </b></br>
