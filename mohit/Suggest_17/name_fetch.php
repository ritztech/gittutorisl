...
DATE_FORMAT(expdate,'%d/%m/%Y') as expdate, `batchno`, `purchase_id`, m1.id as id, `grp_id`, `catid`,weight,p1.name as cat_name ,m1.tax_type as tax_type
...
<td> 
<input type='text'  size = "5" name = "taxtype<?php echo   $i ?>"  value = "<?php  echo $row['tax_type'];  ?>" onchange='updatemrp("<?php echo  $row['id'] ?>","<?php echo  $i ?>")'/>
