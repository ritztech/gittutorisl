...
and p_date between STR_TO_DATE('$st_1','%d/%m/%Y')  and STR_TO_DATE('$end_1','%d/%m/%Y') 
...
<tr bgcolor="yellow"  > <th> ID </th> <th> DATE </th>  <th> VENDOR  </th> <th> RECEIPT NO </th>  <th> CASH/CREDIT </th> <th> TOTAL </th>  </tr> 
