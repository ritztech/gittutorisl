...
$m_entry_in = $_POST['printid'];

  $sqlinv_due = "delete from barcode_print_record  where record_id = $m_entry_in";
  //echo $sqlinv_due;
...
<INPUT class="btn" Type="BUTTON" VALUE="CLOSE" ONCLICK="window.location.href='purchase_add_front_barcode.php'">
