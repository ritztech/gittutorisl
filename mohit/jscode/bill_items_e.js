   ...
   function addRow(tableID,drugitrmno,drugdesc,sprice,mrp,freeqty,grpid,weight_n,tatypeee)
    {
	  ...
	  element4.size = "10";
	   ...
	   function addRow_u(tableID,drugitrmno_u,drugdesc_u,weight_n_u,mrp_u,sprice_u,qty_u,grpid_u,tatypeee)
    {
