...
function isDate(dtStr){
    ...
    if (dtStr.indexOf(dtCh,pos2+1)!=-1 || isInteger(stripCharsInBag(dtStr, dtCh))==false){
        alert("Please enter a valid expiary date date")
        return false
    }
return true
}
...
for (var init=1; init<=tcnt; init++)
  {
	  ...
	  var dt=document.form2[ "expdate" + init ]
		...
		if( document.form2[ "qty" + init ].value == "" )
   {
     ...
     return false;
   		...
   		if( document.form2[ "mrp" + init ].value == "" )
   {
     alert( "Please fill MRP !" );
     document.form2[ "mrp" + init ].focus() ;
     return false;
   }
...
if( document.form2.cst_name.value == "" )
   {
