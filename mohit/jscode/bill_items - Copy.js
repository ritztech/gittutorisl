...
for (var i=1; i<=j; i++)
 ...
 document.form2[ "ttotaldis" + i ].value = (Number(valmrp) - Number(val1)) * Number(val2);
...
var cash_t4 = eval("document.form2.totalcredit.value");

   
document.form2.totaldue.value = tot - (Number(cash_t1) + Number(cash_t2) + Number(cash_t3) + Number(cash_t4));
...
document.form2.totaldue.value = tot - (Number(cash_t1) + Number(cash_t2) + Number(cash_t3) + Number(cash_t4));	
   ...
   function addRow(tableID,drugitrmno,drugdesc,sprice,mrp,freeqty)
    {
...
function shappycode1(){
  ...
  document.form2.totalcash.value = document.form2.netpay.value;
