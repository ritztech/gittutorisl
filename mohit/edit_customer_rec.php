...
<form  name = "form1" method="post"  action = "edit_customer_rec_back.php"  >

<h3 align="center"> UPDATE CUSTOMER DETAIL </h3> 
</br>
...
<table width="200" border="1" align="center">
  <tbody>
    <tr>
      <td>ID:</td>
      <td><input type = "text" readonly  size = "40" name = "vid" value= "<?php echo  $row1['2']?>" id = "vid"/></td>
    </tr>
    <tr>
      <td>Name:</td>
