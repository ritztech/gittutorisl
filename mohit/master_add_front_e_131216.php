...
$result1 = mysql_query("SELECT `desc`, `s_price`, `qty`, `trg`, `mrp`, `barcode`, DATE_FORMAT(dop,'%d/%m/%Y')  as  dop,
 ...
 `catid`,weight FROM `m_master_store` WHERE id = $id");
...
WEIGHT: : <input type = "text" size="50" value = "<?php echo $row1['weight']  ?>"  name = "weight" id = "weight"/> </td>   </tr>
...
<tr>   <td>Date of Packing: <input type = "text" size="30"  onchange = "isDate(this.value)"  value = "<?php echo $row1['expdate']  ?>"  name = "dop"  id = "dop"/> <a href="javascript:NewCal('dop','ddmmyyyy')"><img src="image/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
<td>Expiary Date: <input type = "text" size="30"  onchange = "isDate(this.value)" value = "<?php echo $row1['dop']  ?>" name = "expdate"  id = "expdate"/> <a href="javascript:NewCal('expdate','ddmmyyyy')"><img src="image/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>  </td>  </td>   </tr>
...
<tr> <td  style="text-align:center" colspan="2"  >     </br>
 <input type="button" onclick="myFunction()" value="ADD ITEM"  style = "color:blue; font-weight:bold;height: 25px; width: 95px; font:"Times New Roman", Times, serif; font-size:14px;" > 
  </td>   </tr>
